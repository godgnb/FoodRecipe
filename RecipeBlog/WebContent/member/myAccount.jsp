                            ...
                            <form name="frm"  method="get" id="join">
                                <div class="row" >
                                    <div class="col-8">
                                        ...
                                        <input class="btn bueno-btn mt-30 mr-15" type="button" value="Edit" id="edit" onclick="location.href='edit.jsp?id=<%=memberVO.getId() %>';">
                                        <input class="btn bueno-btn mt-30 mr-15" type="button" value="Delete" id="delete" onclick="">
